  ...
  <header class="p-3">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <form action="<?=ROOT?>/search" class="col-12 search col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search">
          <input value="<?=$_GET['find'] ?? ''?>" name="find" type="search" class="form-control search form-control-dark text-dark" placeholder="Search..." aria-label="Search">
        </form>
