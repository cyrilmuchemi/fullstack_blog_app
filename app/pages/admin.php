  ...
  if($action == 'add')
  {
    ...
    //edit user 
      ...
      if($action == 'edit')
      {
        ...
        $query_row = 'select * from users where id = :id limit 1';
        $row = query($query_row, ['id'=>$id]);
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">MetaBlog</a>
